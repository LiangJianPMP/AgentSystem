    ...
    <div id="ku" >
       ...
       <form action="appadd" method="post">
           <div class="layui-input-block" align="center">
                   ...
                   <div class="layui-form-item">
                           <input type="text" id="name" name="name" required="" lay-verify="required" placeholder="配置年限" autocomplete="off" class="layui-input layui-form-danger" style="width: 300px" readonly="readonly">
