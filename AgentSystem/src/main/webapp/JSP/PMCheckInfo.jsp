		      ...
		      <div class="layui-card">
		        ...
		        <div class="layui-card-body">
					<table width="100%" style="margin-left: 10px;">
						<tr>
							<td>登录账号:<label></label></td>
							<td>登录密码:<label></label></td>
						</tr>
						<tr>
						...
						<tr>
							<td>客户端下载地址(IOS):<label></label></td>
							<td>二维码下载地址(IOS):<label></label></td>
						</tr>
						<tr>
							<td>客户端下载地址(Android):<label></label></td>
							<td>二维码下载地址(Android):<label></label></td>
						</tr>
						<tr>
